...
LuaMethods<EntityPtr> LuaUserDataMethods<EntityPtr>::make() {
  ...
  methods.registerMethodWithSignature<bool, EntityPtr>("exists",
    [&](EntityPtr const& entity) -> bool {
      return entity->inWorld();
  });

  methods.registerMethodWithSignature<EntityId, EntityPtr>("id",
    [&](EntityPtr const& entity) -> EntityId {
      return entity->entityId();
  });

  methods.registerMethodWithSignature<bool, EntityPtr, EntityId>("canDamage",
  ...
  methods.registerMethodWithSignature<Json, EntityPtr>("damageTeam",
    [&](EntityPtr const& entity) -> Json {
      return entity->getTeam().toJson();
  });

  methods.registerMethodWithSignature<Json, EntityPtr>("aggressive",
    [&](EntityPtr const& entity) -> Json {
  ...
  methods.registerMethodWithSignature<LuaString, EntityPtr, LuaEngine&>("type",
    [&](EntityPtr const& entity, LuaEngine& engine) -> LuaString {
      return engine.createString(EntityTypeNames.getRight(entity->entityType()));
  });

  methods.registerMethodWithSignature<Vec2F, EntityPtr>("position",
    [&](EntityPtr const& entity) -> Vec2F {
      return entity->position();
  });

  methods.registerMethodWithSignature<RectF, EntityPtr>("metaBoundBox",
    [&](EntityPtr const& entity) -> RectF {
      return entity->metaBoundBox();
  });

  methods.registerMethodWithSignature<Maybe<Vec2F>, EntityPtr>("velocity",
  ...
  methods.registerMethodWithSignature<String, EntityPtr>("name",
    [&](EntityPtr const& entity) -> String {
      return entity->name();
  });

  methods.registerMethodWithSignature<Maybe<String>, EntityPtr, Maybe<String>>("description",
  ...
  methods.registerMethodWithSignature<LuaNullTermWrapper<Maybe<String>>, EntityPtr>("uniqueId",
    [&](EntityPtr const& entity) -> LuaNullTermWrapper<Maybe<String>> {
      return entity->uniqueId();
  });

  methods.registerMethodWithSignature<Json, EntityPtr, String, Maybe<Json>>("getParameter",
  ...
  methods.registerMethodWithSignature<Maybe<Json>, EntityPtr>("nametag",
  ...
  methods.registerMethodWithSignature<LuaNullTermWrapper<Maybe<List<Drawable>>>, EntityPtr, String>("portrait",
  ...
  methods.registerMethodWithSignature<Maybe<Vec2F>, EntityPtr>("health",
    [&](EntityPtr const& entity) -> Maybe<Vec2F> {
  ...
  methods.registerMethodWithSignature<Maybe<String>, EntityPtr, String>("handItem",
  ...
  methods.registerMethodWithSignature<Json, EntityPtr, String>("handItemDescriptor",
  ...
  methods.registerMethodWithSignature<Maybe<String>, EntityPtr>("species",
  ...
  methods.registerMethodWithSignature<Maybe<String>, EntityPtr>("gender",
    [&](EntityPtr const& entity) -> Maybe<String> {
      if (auto player = as<Player>(entity)) {
  ...
  // player methods
  methods.registerMethodWithSignature<Maybe<uint64_t>, EntityPtr, String>("currency",
  ...
  methods.registerMethodWithSignature<Maybe<uint64_t>, EntityPtr, Json, Maybe<bool>>("hasCountOfItem",
  ...
  // object methods
  methods.registerMethodWithSignature<List<Vec2I>, EntityPtr>("objectSpaces",
  ...
  methods.registerMethodWithSignature<Maybe<int>, EntityPtr>("farmableStage",
