...
#include "gles.h"
    ...
    void APIENTRY_GL4ES gl4es_glTexImage2D(GLenum target, GLint level, GLint internalFormat, GLsizei width,
                                           GLsizei height, GLint border, GLenum format, GLenum type,
                                           const GLvoid* data);

    void APIENTRY_GL4ES gl4es_glTexImage1D(GLenum target, GLint level, GLint internalFormat, GLsizei width,
                                           GLint border, GLenum format, GLenum type, const GLvoid* data);

    void APIENTRY_GL4ES gl4es_glTexImage3D(GLenum target, GLint level, GLint internalFormat, GLsizei width,
    ...
    void APIENTRY_GL4ES gl4es_glBindImageTexture(GLuint unit, GLuint texture, GLint level, GLboolean layered,
    ...
    void APIENTRY_GL4ES gl4es_glCopyTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
