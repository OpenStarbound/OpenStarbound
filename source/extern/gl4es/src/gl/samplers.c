...
void del_sampler(GLuint sampler) {
    ...
    if (s) {
        for (int i = 0; i < MAX_TEX; ++i)
            if (glstate->samplers.sampler[i] == s) glstate->samplers.sampler[i] = NULL;
...
void gl4es_glBindSampler(GLuint unit, GLuint sampler) {
    ...
    if (glstate->bound_changed < unit + 1) glstate->bound_changed = unit + 1;
}
...
int samplerParameterfv(glsampler_t* sampler, GLenum pname, const GLfloat* params) {
    DBG(SHUT_LOGD("samplerParameterfv(%p(%d), %s, [%f(%s)...])\n", sampler, sampler->glname, PrintEnum(pname),
                  params[0], PrintEnum(params[0]));)
    GLint param = *params;
    switch (pname) {
...
void gl4es_glSamplerParameterfv(GLuint sampler, GLenum pname, GLfloat* params) {
    ...
    if (!samplerParameterfv(s, pname, params)) errorShim(GL_INVALID_ENUM);
...
void gl4es_glSamplerParameteriv(GLuint sampler, GLenum pname, GLint* params) {
    ...
    if (!samplerParameterfv(s, pname, fparam)) errorShim(GL_INVALID_ENUM);
    if (pname == GL_TEXTURE_BORDER_COLOR) {
...
void gl4es_glGetSamplerParameterfv(GLuint sampler, GLenum pname, GLfloat* params) {
    ...
    if (!getSamplerParameterfv(s, pname, params)) errorShim(GL_INVALID_ENUM);
}
...
AliasExport(void, glSamplerParameterfv, , (GLuint sampler, GLenum pname, const GLfloat* params));
AliasExport(void, glSamplerParameteriv, , (GLuint sampler, GLenum pname, const GLint* params));
AliasExport(void, glSamplerParameterIiv, , (GLuint sampler, GLenum pname, const GLint* params));
AliasExport(void, glSamplerParameterIuiv, , (GLuint sampler, GLenum pname, const GLuint* params));
AliasExport(void, glGetSamplerParameterfv, , (GLuint sampler, GLenum pname, GLfloat* params));
AliasExport(void, glGetSamplerParameteriv, , (GLuint sampler, GLenum pname, GLint* params));
