...
#define VARTYPE2STR(vartype)                                                                                           \
    (ENUMVALUE2STR(vartype, VARTYPE_, ADDRESS) ENUMVALUE2STR(vartype, VARTYPE_, ATTRIB)                                \
         ENUMVALUE2STR(vartype, VARTYPE_, PARAM) ENUMVALUE2STR(vartype, VARTYPE_, PARAM_MULT)                          \
             ENUMVALUE2STR(vartype, VARTYPE_, TEMP) ENUMVALUE2STR(vartype, VARTYPE_, OUTPUT)                           \
                 ENUMVALUE2STR(vartype, VARTYPE_, CONST) "???")
#define INST2STR(inst)                                                                                                 \
    (ENUMVALUE2STR(inst, INST_, ABS) ENUMVALUE2STR(inst, INST_, ADD) ENUMVALUE2STR(inst, INST_, ARL) ENUMVALUE2STR(    \
        inst, INST_, CMP) ENUMVALUE2STR(inst, INST_, COS) ENUMVALUE2STR(inst, INST_, DP3)                              \
         ENUMVALUE2STR(inst, INST_, DP4) ENUMVALUE2STR(inst, INST_, DPH) ENUMVALUE2STR(inst, INST_, DST)               \
             ENUMVALUE2STR(inst, INST_, EX2) ENUMVALUE2STR(inst, INST_, EXP) ENUMVALUE2STR(inst, INST_, FLR)           \
                 ENUMVALUE2STR(inst, INST_, FRC) ENUMVALUE2STR(inst, INST_, KIL) ENUMVALUE2STR(inst, INST_, LG2)       \
                     ENUMVALUE2STR(inst, INST_, LIT) ENUMVALUE2STR(inst, INST_, LOG) ENUMVALUE2STR(inst, INST_, LRP)   \
                                             ...
                                             ENUMVALUE2STR(inst, INST_, SIN) ENUMVALUE2STR(inst, INST_, SLT)           \
                                                 ENUMVALUE2STR(inst, INST_, SUB) ENUMVALUE2STR(inst, INST_, SWZ)       \
                                                     ENUMVALUE2STR(inst, INST_, TEX) ENUMVALUE2STR(inst, INST_, TXB)   \
                                                         ENUMVALUE2STR(inst, INST_, TXP)                               \
                                                             ENUMVALUE2STR(inst, INST_, XPD) "???")
#define STATUS2STR(s)                                                                                                  \
    (ENUMVALUE2STR(s, ST_, LINE_START) ENUMVALUE2STR(s, ST_, LINE_COMMENT) ENUMVALUE2STR(s, ST_, VARIABLE)             \
         ENUMVALUE2STR(s, ST_, VARIABLE_INIT) ENUMVALUE2STR(s, ST_, ALIAS) ENUMVALUE2STR(s, ST_, ALIASING)             \
             ENUMVALUE2STR(s, ST_, INSTRUCTION) ENUMVALUE2STR(s, ST_, OPTION) ENUMVALUE2STR(s, ST_, DONE)              \
                 ENUMVALUE2STR(s, ST_, ERROR) "???")
#endif
#define TOKEN2STR(t)                                                                                                   \
    (ENUMVALUE2STR(t, TOK_, NULL) ENUMVALUE2STR(t, TOK_, WHITESPACE) ENUMVALUE2STR(t, TOK_, SIGN)                      \
         ENUMVALUE2STR(t, TOK_, INTEGER) ENUMVALUE2STR(t, TOK_, FLOATCONST) ENUMVALUE2STR(t, TOK_, IDENTIFIER)         \
             ENUMVALUE2STR(t, TOK_, POINT) ENUMVALUE2STR(t, TOK_, UPTO) ENUMVALUE2STR(t, TOK_, COMMA)                  \
                 ENUMVALUE2STR(t, TOK_, EQUALS) ENUMVALUE2STR(t, TOK_, LSQBRACKET) ENUMVALUE2STR(t, TOK_, RSQBRACKET)  \
                     ENUMVALUE2STR(t, TOK_, LBRACE) ENUMVALUE2STR(t, TOK_, RBRACE) ENUMVALUE2STR(t, TOK_, END_OF_INST) \
                         ENUMVALUE2STR(t, TOK_, LINE_COMMENT) ENUMVALUE2STR(t, TOK_, NEWLINE)                          \
                             ENUMVALUE2STR(t, TOK_, END) ENUMVALUE2STR(t, TOK_, UNKNOWN) "???")
