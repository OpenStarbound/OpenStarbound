...
#define CHECK_PROGRAM(type, program)                                                                                   \
    ...
    {                                                                                                                  \
        ...
        if (k_##program != kh_end(programs)) glprogram = kh_value(programs, k_##program);                              \
    }                                                                                                                  \
    if (!glprogram) {                                                                                                  \
...
#define APPLY_PROGRAM(prg, glprg)                                                                                      \
    if (glstate->gleshard->program != prg) {                                                                           \
        ...
        if (gles_glUseProgram) gles_glUseProgram(prg);                                                                 \
    }
...
GLvoid APIENTRY_GL4ES glGetActiveAttribARB(GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei* length,
...
GLvoid APIENTRY_GL4ES glShaderSourceARB(GLhandleARB shaderObj, GLsizei count, const GLcharARB** string,
                                        const GLint* length);
...
GLvoid APIENTRY_GL4ES glGetAttachedObjectsARB(GLhandleARB containerObj, GLsizei maxCount, GLsizei* count,
                                              GLhandleARB* obj);
GLint APIENTRY_GL4ES glGetUniformLocationARB(GLhandleARB programObj, const GLcharARB* name);
GLvoid APIENTRY_GL4ES glGetActiveUniformARB(GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei* length,
                                            GLint* size, GLenum* type, GLcharARB* name);
